...
const (
	S3SignatureVersion_UNKNOWN S3SignatureVersion = 0
	// Signature Version 2
...
type S3BucketInfo struct {
	...
	SignatureVersion S3SignatureVersion `protobuf:"varint,4,opt,name=signature_version,json=signatureVersion,proto3,enum=sigs.k8s.io.cosi.v1alpha2.S3SignatureVersion" json:"signature_version,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_cosi_proto_rawDesc = "" +
	...
	"\x14DriverGetInfoRequest\"\x17\n" +
	"\x15DriverGetInfoResponse\"\xbb\x01\n" +
	...
	"\x11signature_version\x18\x04 \x01(\x0e2-.sigs.k8s.io.cosi.v1alpha2.S3SignatureVersionR\x10signatureVersion\"^\n" +
	"\fS3AccessInfo\x12\"\n" +
	"\raccess_key_id\x18\x01 \x01(\tR\vaccessKeyId\x12*\n" +
	"\x11access_secret_key\x18\x02 \x01(\tR\x0faccessSecretKey\":\n" +
	...
	" DriverRevokeBucketAccessResponse*5\n" +
	"\x12S3SignatureVersion\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\b\n" +
	"\x04S3V2\x10\x01\x12\b\n" +
	"\x04S3V4\x10\x022\x80\x01\n" +
	"\bIdentity\x12t\n" +
...
var file_cosi_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_cosi_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_cosi_proto_goTypes = []any{
	(S3SignatureVersion)(0),                  // 0: sigs.k8s.io.cosi.v1alpha2.S3SignatureVersion
	(*DriverGetInfoRequest)(nil),             // 1: sigs.k8s.io.cosi.v1alpha2.DriverGetInfoRequest
	(*DriverGetInfoResponse)(nil),            // 2: sigs.k8s.io.cosi.v1alpha2.DriverGetInfoResponse
	(*S3BucketInfo)(nil),                     // 3: sigs.k8s.io.cosi.v1alpha2.S3BucketInfo
	(*S3AccessInfo)(nil),                     // 4: sigs.k8s.io.cosi.v1alpha2.S3AccessInfo
	(*AzureBucketInfo)(nil),                  // 5: sigs.k8s.io.cosi.v1alpha2.AzureBucketInfo
	(*AzureAccessInfo)(nil),                  // 6: sigs.k8s.io.cosi.v1alpha2.AzureAccessInfo
	(*GcsBucketInfo)(nil),                    // 7: sigs.k8s.io.cosi.v1alpha2.GcsBucketInfo
	(*GcsAccessInfo)(nil),                    // 8: sigs.k8s.io.cosi.v1alpha2.GcsAccessInfo
	(*DriverCreateBucketRequest)(nil),        // 9: sigs.k8s.io.cosi.v1alpha2.DriverCreateBucketRequest
	(*DriverCreateBucketResponse)(nil),       // 10: sigs.k8s.io.cosi.v1alpha2.DriverCreateBucketResponse
	(*DriverGetExistingBucketRequest)(nil),   // 11: sigs.k8s.io.cosi.v1alpha2.DriverGetExistingBucketRequest
	(*DriverGetExistingBucketResponse)(nil),  // 12: sigs.k8s.io.cosi.v1alpha2.DriverGetExistingBucketResponse
	(*DriverDeleteBucketRequest)(nil),        // 13: sigs.k8s.io.cosi.v1alpha2.DriverDeleteBucketRequest
	(*DriverDeleteBucketResponse)(nil),       // 14: sigs.k8s.io.cosi.v1alpha2.DriverDeleteBucketResponse
	(*DriverGrantBucketAccessRequest)(nil),   // 15: sigs.k8s.io.cosi.v1alpha2.DriverGrantBucketAccessRequest
	(*DriverGrantBucketAccessResponse)(nil),  // 16: sigs.k8s.io.cosi.v1alpha2.DriverGrantBucketAccessResponse
	(*DriverRevokeBucketAccessRequest)(nil),  // 17: sigs.k8s.io.cosi.v1alpha2.DriverRevokeBucketAccessRequest
	(*DriverRevokeBucketAccessResponse)(nil), // 18: sigs.k8s.io.cosi.v1alpha2.DriverRevokeBucketAccessResponse
...
var file_cosi_proto_depIdxs = []int32{
	0,  // 0: sigs.k8s.io.cosi.v1alpha2.S3BucketInfo.signature_version:type_name -> sigs.k8s.io.cosi.v1alpha2.S3SignatureVersion
	19, // 1: sigs.k8s.io.cosi.v1alpha2.alpha_enum:extendee -> google.protobuf.EnumOptions
	20, // 2: sigs.k8s.io.cosi.v1alpha2.alpha_enum_value:extendee -> google.protobuf.EnumValueOptions
	21, // 3: sigs.k8s.io.cosi.v1alpha2.cosi_secret:extendee -> google.protobuf.FieldOptions
	21, // 4: sigs.k8s.io.cosi.v1alpha2.alpha_field:extendee -> google.protobuf.FieldOptions
	22, // 5: sigs.k8s.io.cosi.v1alpha2.alpha_message:extendee -> google.protobuf.MessageOptions
	23, // 6: sigs.k8s.io.cosi.v1alpha2.alpha_method:extendee -> google.protobuf.MethodOptions
	24, // 7: sigs.k8s.io.cosi.v1alpha2.alpha_service:extendee -> google.protobuf.ServiceOptions
	1,  // 8: sigs.k8s.io.cosi.v1alpha2.Identity.DriverGetInfo:input_type -> sigs.k8s.io.cosi.v1alpha2.DriverGetInfoRequest
	9,  // 9: sigs.k8s.io.cosi.v1alpha2.Provisioner.DriverCreateBucket:input_type -> sigs.k8s.io.cosi.v1alpha2.DriverCreateBucketRequest
	11, // 10: sigs.k8s.io.cosi.v1alpha2.Provisioner.DriverGetExistingBucket:input_type -> sigs.k8s.io.cosi.v1alpha2.DriverGetExistingBucketRequest
	13, // 11: sigs.k8s.io.cosi.v1alpha2.Provisioner.DriverDeleteBucket:input_type -> sigs.k8s.io.cosi.v1alpha2.DriverDeleteBucketRequest
	15, // 12: sigs.k8s.io.cosi.v1alpha2.Provisioner.DriverGrantBucketAccess:input_type -> sigs.k8s.io.cosi.v1alpha2.DriverGrantBucketAccessRequest
	17, // 13: sigs.k8s.io.cosi.v1alpha2.Provisioner.DriverRevokeBucketAccess:input_type -> sigs.k8s.io.cosi.v1alpha2.DriverRevokeBucketAccessRequest
	2,  // 14: sigs.k8s.io.cosi.v1alpha2.Identity.DriverGetInfo:output_type -> sigs.k8s.io.cosi.v1alpha2.DriverGetInfoResponse
	10, // 15: sigs.k8s.io.cosi.v1alpha2.Provisioner.DriverCreateBucket:output_type -> sigs.k8s.io.cosi.v1alpha2.DriverCreateBucketResponse
	12, // 16: sigs.k8s.io.cosi.v1alpha2.Provisioner.DriverGetExistingBucket:output_type -> sigs.k8s.io.cosi.v1alpha2.DriverGetExistingBucketResponse
	14, // 17: sigs.k8s.io.cosi.v1alpha2.Provisioner.DriverDeleteBucket:output_type -> sigs.k8s.io.cosi.v1alpha2.DriverDeleteBucketResponse
	16, // 18: sigs.k8s.io.cosi.v1alpha2.Provisioner.DriverGrantBucketAccess:output_type -> sigs.k8s.io.cosi.v1alpha2.DriverGrantBucketAccessResponse
	18, // 19: sigs.k8s.io.cosi.v1alpha2.Provisioner.DriverRevokeBucketAccess:output_type -> sigs.k8s.io.cosi.v1alpha2.DriverRevokeBucketAccessResponse
